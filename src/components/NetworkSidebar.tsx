...
>
  ...
  <span>Arc Lineal</span>
      ...
      {/* 3D Controls Section - Shown only for 3D visualization type */}
      {visualizationType === '3d' && (
        <div className="px-5 mb-3">
          <button 
            className="bg-gray-700 w-full p-2.5 rounded-md flex justify-between items-center cursor-pointer mb-1"
                ...
                <div className="grid grid-cols-3 gap-2 mt-4">
                  {onResetView && (
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="col-span-3 text-xs bg-gray-600 text-white hover:bg-gray-500"
                      onClick={onResetView}
                    >
                  ...
                  {onZoomIn && onZoomOut && (
                    <>
                      <Button 
                        variant="outline" 
                        size="sm" 
                        className="text-xs bg-gray-600 text-white hover:bg-gray-500"
                        onClick={onZoomIn}
                      >
